...
EGO_SUM=(
	...
	"cloud.google.com/go/storage v1.4.0/go.mod"
	...
	"github.com/ajeddeloh/go-json v0.0.0-20170920214419-6a2fe990e083/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.25.47/go.mod"
	...
	"github.com/c4milo/gotoolkit v0.0.0-20170704181456-e37eeabad07e/go.mod"
	...
	"github.com/coreos/ignition v0.34.0/go.mod"
	...
	"github.com/hashicorp/go-hclog v0.10.0/go.mod"
	...
	"github.com/hashicorp/hcl/v2 v2.1.0/go.mod"
	...
	"github.com/hashicorp/terraform-config-inspect v0.0.0-20191121111010-e9629612a215/go.mod"
	"github.com/hashicorp/terraform-plugin-sdk v1.4.0"
	"github.com/hashicorp/terraform-plugin-sdk v1.4.0/go.mod"
	...
	"github.com/hashicorp/terraform-svchost v0.0.0-20191119180714-d2e4933b9136/go.mod"
	...
	"github.com/hooklift/iso9660 v1.0.0/go.mod"
	...
	"github.com/libvirt/libvirt-go v5.0.0+incompatible/go.mod"
	"github.com/libvirt/libvirt-go-xml v5.0.0+incompatible"
	"github.com/libvirt/libvirt-go-xml v5.0.0+incompatible/go.mod"
	...
	"github.com/mitchellh/packer v1.3.2/go.mod"
	...
	"github.com/terraform-providers/terraform-provider-ignition v1.2.1/go.mod"
	"github.com/ulikunitz/xz v0.5.5"
	"github.com/ulikunitz/xz v0.5.5/go.mod"
	"github.com/ulikunitz/xz v0.5.6"
	"github.com/ulikunitz/xz v0.5.6/go.mod"
	"github.com/vincent-petithory/dataurl v0.0.0-20160330182126-9a301d65acbb"
	"github.com/vincent-petithory/dataurl v0.0.0-20160330182126-9a301d65acbb/go.mod"
	...
	"github.com/zclconf/go-cty v1.1.1/go.mod"
	...
	"go4.org v0.0.0-20191010144846-132d2879e1e9/go.mod"
	...
	"golang.org/x/tools v0.0.0-20191204011308-9611592c72f6/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20191203220235-3fa9dbf08042/go.mod"
...
src_compile() {
	...
	CGO_ENABLED="1" go build "${flags[@]}" || die "build failed"
}
