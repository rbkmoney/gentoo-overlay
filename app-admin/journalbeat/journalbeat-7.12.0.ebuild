...
DESCRIPTION="Data collector to ship systemd journal entries to Elasticsearch or Logstash"
...
src_install() {
	...
	docinto examples
	dodoc ${PN}/{journalbeat.yml,journalbeat.reference.yml}

	dobin journalbeat/journalbeat
}
